...
On macOS, generate an annotated screenshot from Accessibility frames. The numeric ids are generated by this wrapper for the current capture; use them with the matching fresh state, not as durable OS-level identifiers.
